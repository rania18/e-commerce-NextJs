    ...
    switch (action.type) {
        ...
        case "resetOptions":
            ...
            return {
                ...
                options: __assign(__assign({}, action.value), { "data-react-paypal-script-id": "" + getNewScriptID() }),
            };
        default: {
            return state;
        }
...
var PayPalScriptProvider = function (_a) {
    ...
    var initialState = {
        options: __assign(__assign({}, options), { "data-react-paypal-script-id": "" + getNewScriptID() }),
        loadingStatus: deferLoading
            ? SCRIPT_LOADING_STATE.INITIAL
            : SCRIPT_LOADING_STATE.PENDING,
    };
    var _c = React.useReducer(scriptReducer, initialState), state = _c[0], dispatch = _c[1];
